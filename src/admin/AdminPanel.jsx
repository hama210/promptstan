...
import { BarChart3, CalendarClock, KeyRound, Plus, RefreshCw, ShieldCheck, Sparkles } from 'lucide-react';
  ...
  return (
    <main className="adminShell" dir="rtl">
      <header className="adminHero">
        <div>
          <span className="adminBadge"><ShieldCheck size={18} /> Promptstan Admin</span>
          <h1>بەڕێوەبردنی پڕۆمپتستان</h1>
          <p>پرۆمپت زیاد بکە، ڕۆژانە بڵاوکردنەوە بکە، و ئاماری ماڵپەڕ ببینە.</p>
        </div>
        <a className="adminHome" href="/">گەڕانەوە بۆ ماڵەوە</a>
      </header>

      <section className="adminCard tokenCard">
        <div className="adminCardTitle"><KeyRound size={22} /><h2>Admin Token</h2></div>
        <p>ئەو secret ـەی لە Cloudflare بە ناوی <b>ADMIN_TOKEN</b> داتناوە، لێرە دابنێ.</p>
      ...
      <section className="adminCard dailyCard">
        <div>
          <div className="adminCardTitle"><CalendarClock size={22} /><h2>Daily Prompt Bot</h2></div>
          <p>بۆت ڕۆژانە پرۆمپت بڵاو دەکات. دەتوانیت ئێستا بە دەستی هەمان کار بکەیت.</p>
        </div>
        <button onClick={publishDailyNow} disabled={!savedToken || loading}>Publish today now</button>
      </section>

      <section className="adminCard">
        <div className="adminCardTitle"><Plus size={22} /><h2>زیادکردنی پرۆمپت</h2></div>
        <form className="promptForm" onSubmit={createPrompt}>
